...
let handler = async (m, { conn, args, text, usedPrefix, command, isROwner }) => {
    let _p = usedPrefix
    const linkgc = 'https://chat.whatsapp.com/FsEi7PWk56FGkPwlkPP2MJ'
    const domain = 'https://panel.kasanudin.com'
    const apikey = 'ptla_hjhD1PF8zYuHRKdoUz2LhrHUqViyCV7yXHVFwyZipDW'
    const c_apikey = 'ptlc_aVE7WV82bTZbVeLdabWj2QusbpryBNhF1r4yyZAr4ic'
    switch (command) {
        case 'addusr': {
